...
class DwarfQueenClient:
    ...
    def _split_into_subtasks(self, task: str, original_task: str = "") -> list:
        ...
        if num_workers and num_workers >= 2:
            ...
            prompt = f"""Split this into exactly {num_workers} parts.
...
{fraction_instructions}"""
            ...
            prompt = f"""Split this into 2-4 parts.
...
def main():
    ...
    parser.add_argument('--model', type=str,
                        default=os.environ.get('KILLERBEE_MODEL', 'phi4-mini:3.8b'),
                        help='Ollama model (env: KILLERBEE_MODEL, tier default phi4-mini:3.8b)')
